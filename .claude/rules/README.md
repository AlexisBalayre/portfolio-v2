...
| `content-conventions` | `public/assets/data/**`, `public/assets/img/**`, `public/llms.txt`, `content/**` | JSON shapes per file, allowed HTML in strings, logo/image requirements, `llms.txt` + metadata sync → `content.md` |
