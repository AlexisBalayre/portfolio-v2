...
| :------------------------------------------------------------ | :----------------------------------- | :--------------------------------------- |
| Page structure, sections, how a section renders               | `docs/reference/architecture.md`     | `app/page.tsx`, `components/*.tsx`       |
...
| SEO: metadata, Open Graph, JSON-LD, sitemap, robots, llms.txt | `docs/reference/architecture.md`     | `app/layout.tsx`, `next-sitemap.config.js` |
