...
Pendant l'exécution, j'interviens peu. C'est là que [la configuration décrite dans l'article précédent](/fr/blog/claude-code-fast-and-reliable) fait son travail :
...
Dans [le prochain article](/fr/blog/pr-review-pipeline), je détaille la review CI : comment six agents reviewers, un validateur et un script sans accès en écriture analysent chaque PR avant qu'elle m'arrive.
