...
Dans [le prochain article](/fr/blog/dev-cycle-with-agents), je détaille mon cycle de développement complet : de la spec à la PR, avec une session qui orchestre et plusieurs agents qui exécutent en parallèle.
